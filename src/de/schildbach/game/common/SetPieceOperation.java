 ...
 */
public class SetPieceOperation implements MicroOperation
{
	private Piece piece;
	private Coordinate target;

	public SetPieceOperation(Piece piece, Coordinate target)
	{
	...
	public void doOperation(GamePosition position)
	{
		...
		assert board.getPiece(target) == null : target + " not empty";
