 ...
 */
public final class CheckersPositionFormat
{
	public static String format(CheckersBoardGeometry geometry, PieceSet pieceSet, CapturingGamePosition position)
	{
		...
		// active color
		fen.append(" ");
		fen.append(CheckersColor.colorNotation(position.getActivePlayerIndex()));
	...
	public static CapturingGamePosition parse(CheckersBoardGeometry geometry, PieceSet pieceSet, String fen)
	{
		try
		{
			...
			FenFormat.parse(geometry, pieceSet, tokenizer.nextToken(), board);
			CapturingGamePosition position = new CapturingGamePosition(board);

			// active color
			position.setActivePlayerIndex(CheckersColor.notationToColor(tokenizer.nextToken().charAt(0)));
